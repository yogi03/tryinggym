...
function getFriendlyError(err: unknown): string {
  ...
  const code = e?.code || "";
  if (code === "auth/user-not-found") return "No admin account found with this email address.";
  ...
  return e?.message?.includes("not registered as an admin")
      ...
      <Card className="max-w-md w-full">
          ...
          <>
            <CardHeader className="text-center">
              <div className="flex justify-center mb-6">
                <Link href="/" className="transition-transform hover:scale-105 duration-300">
                  <Image src="/gymmanagr-logo.png" alt="GymManagr Logo" width={180} height={45} className="h-12 w-auto object-contain" priority />
                </Link>
              </div>
            ...
            <form onSubmit={handleLogin} autoComplete="off">
              ...
              <CardFooter className="flex flex-col gap-4">
                ...
                <Button type="button" variant="outline" className="w-full" onClick={() => router.push("/trainer/login")}>
                  Trainer Login
                </Button>
                <Button type="button" variant="outline" className="w-full" onClick={() => router.push("/front-desk/login")}>
                  Front Desk Login
                </Button>
                {/* <Button type="button" variant="outline" className="w-full" onClick={() => router.push("/developer/login")}>
                  Developer Login
                </Button> */}
                {/* <div className="text-center text-sm">
                  <span className="text-muted-foreground font-light mb-1 block italic">New owners?</span>
                  <Button variant="outline" className="w-full" onClick={() => router.push("/admin/onboarding")}>
                    Register your gym
                  </Button>
                </div> */}
              </CardFooter>
        ...
        {view === "forgot-email" && (
          <>
            <CardHeader>
              ...
              <CardDescription>Enter your admin email to receive a 4-digit OTP.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {error && <ErrorBanner msg={error} />}
              <div className="space-y-2">
        ...
        {view === "forgot-otp" && (
          <>
            ...
            <CardContent className="space-y-5">
              ...
              <div className="flex justify-center gap-2 sm:gap-4">
                {otp.map((digit, i) => (
                  <input
                    ...
                    className="w-12 h-12 sm:w-14 sm:h-14 text-center text-xl sm:text-2xl font-bold border-2 rounded-lg bg-background focus:outline-none focus:border-primary transition-colors"
                  />
                ))}
              </div>
              ...
              {/* Resend button (only shown when expired) */}
              {countdown.expired && (
        ...
        {view === "forgot-reset" && (
          <>
            ...
            <CardFooter>
              <Button className="w-full" onClick={handleResetPassword} disabled={isLoading || !allRulesMet || !passwordsMatch}>
                {isLoading && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                Reset Password
              </Button>
            </CardFooter>
