...
function getFriendlyError(err: unknown): string {
  ...
  const code = e?.code || "";
  if (code === "auth/user-not-found") return "No trainer account found with this email address.";
  ...
  return e?.message?.includes("not registered as a trainer")
    ? "This account is not registered as a trainer."
...
export default function TrainerLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/admin/staff/${trainer.staffId}`);
    } catch (err) {
        ...
        {view === "login" && (
          <>
            <CardHeader className="text-center">
              ...
              <CardDescription>Sign in to view your trainer profile and assigned members.</CardDescription>
            </CardHeader>
        ...
        {view === "forgot-email" && (
          <>
            <CardHeader>
              ...
              <CardDescription>Enter your trainer email to receive a 4-digit OTP.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {error && <ErrorBanner msg={error} />}
              <div className="space-y-2">
